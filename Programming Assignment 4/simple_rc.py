...
plt.ylabel(r"$V1$ (V)")
plt.legend()
plt.savefig('reports/task4-simple_rc/V1_vs_Time.png')
...
plt.ylabel(r"$V2$ (V)")
plt.legend()
plt.savefig('reports/task4-simple_rc/V2_vs_Time.png')
...
plt.legend()
plt.savefig('reports/task4-simple_rc/V12_vs_Time.png')